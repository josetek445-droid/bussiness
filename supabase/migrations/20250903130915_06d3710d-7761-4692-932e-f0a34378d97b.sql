...
-- Create RLS policy to allow workers to view categories and subcategories
CREATE POLICY IF NOT EXISTS "Workers can view categories" 
ON public.categories 
FOR SELECT 
USING (true);

CREATE POLICY IF NOT EXISTS "Workers can view subcategories" 
