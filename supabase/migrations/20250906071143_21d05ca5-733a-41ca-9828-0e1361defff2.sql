...
DROP POLICY IF EXISTS "Admin can manage expense requests from their workers" ON expense_requests;
...
DROP POLICY IF EXISTS "Admin can view sales from their workers" ON sales;
